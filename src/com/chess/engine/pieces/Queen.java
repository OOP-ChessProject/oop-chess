...
public class Queen extends Piece {
    ...
    // Combining straight and diagonal sliding vector offsets for the Queen
            ...
            while (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                ...
                if (BoardUtils.isValidTileCoordinate(candidateDestinationCoordinate)) {
                    ...
                    if (!candidateDestinationTile.isTileOccupied()) {
                        ...
                        // Path is blocked by a piece, stop sliding along this line vector direction
                        break;
                    }
                }
            }
    ...
    // Border checks to eliminate wrapping bugs on edge transitions
    ...
    private static boolean isEighthColumnExclusion(final int currentPosition, final int offset) {
        return BoardUtils.EIGHTH_COLUMN[currentPosition] && (offset == 1 || offset == -7 || offset == 9);
    }
}