...
public abstract class Move {
    ...
    private Move(final Board board,
        ...
        // Only check isFirstMove() if the piece actually exists!
    ...
    public static abstract class CastleMove extends Move {
        ...
        public Board execute() {
            ...
            // Re-instantiating Rook cleanly matching your constructor layout (Alliance, position)
            final Rook movedRook = new Rook(this.castleRook.getPieceAlliance(), this.castleRookDestination);
